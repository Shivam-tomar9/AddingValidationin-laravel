                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="account-sidebar">
                        <div class="user">
                            @if ($user->image)
                                        <div class="mt-3">
                                            ...
                                            <img src="data:image/png;base64,{{ $user->image }}" alt="Current Image" class="img-fluid"  style="max-height: 200px; width: 120px; height: 120px; background-color: #e0e0e0; border-radius: 50%;">
                                        </div>
                                    @endif
                            <div class="part-txt">
                                <h3>{{$user->name}}</h3>
                        ...
                        <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a href="{{route('user-logout')}}" class="nav-link"><span class="icon"><i class="fa-duotone fa-power-off"></i></span> <span class="txt">Log out</span></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-9 col-lg-8">
                    <form action="{{route('user-update',$user->id)}}" method="POST" enctype="multipart/form-data" id="myForm" data-parsley-validate> 
                        @csrf
                                    ...
                                    <div class="col-md-8 chat-col">
                                        <div class="chat-area">
                                            ...
                                            <div class="single-msg msg-out">
                                                ...
                                                <div class="part-img">
                                                    <div class="img">
                                                        <img src="{{asset('admin/assets/images/user.jpg')}}" alt="image">
                                                    </div>
                                                    <span>13:57</span>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                            ...
                            <div class="profile-panel">
                                <div class="profile-top">
                                    ...
                                    <div class="btn-box part-img">
                                        <label for="image-upload" class="def-btn">Upload</label>
                                        <input type="file" name="image" id="image-upload" style="display: none;" class="form-control" required>
                                    </div>
                                    ...
                                    <div class="row g-lg-4 g-3">
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Name:"  value="{{ $user->name }}" name="name" class="form-control" required>
                                        </div>
                                      
                                        <div class="col-sm-6">
                                            <input type="email" placeholder="Email Address:"  value="{{ $user->email }}" name="email" class="form-control" required>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="tel" placeholder="Phone:" value="{{ $user->phoneno }}" name="phoneno" class="form-control" required>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Country:" value="{{ $user->country }}" name="country" class="form-control" required>
                                        </div>
                                        
                                        <div class="col-sm-6">
                                            <input type="number" placeholder="Post Code*" value="{{ $user->postcode }}" name="postcode" class="form-control" required>
                                        </div>
                                        {{-- <div class="col-sm-6">
                    ...
                    <div class="modal-body">
                        <div class="invoice-wrap">
                            <div class="invoice-top d-flex justify-content-between align-items-center">
                                <div class="left">
                                    <div class="logo"><img src="{{asset('admin/assets/images/Logo.html')}}" alt="LOGO"></div>
                                    <p>Invoice</p>
                                </div>
                                <div class="right">
                                    <table>
...
<!-- Mirrored from revel-html.codebasket.xyz/account.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 07:33:23 GMT -->
